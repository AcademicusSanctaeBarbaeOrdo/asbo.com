...
class QuizzAnnoHasFraSpec extends ObjectBehavior
{
    ...
    public function it_has_no_quizz_anno_by_default()
    {
     ...
     */
    public function its_quizz_anno_is_muttable($quizzAnno)
    {
     ...
     */
    public function its_fra_is_mutable($fra)
    {
        $this->setFra($fra);
        $this->getFra()->shouldReturn($fra);
    }

    public function it_has_no_points_by_default()
    {
        $this->getPoints()->shouldReturn(null);
    }

    public function its_points_is_mutable()
    {
        $this->setPoints(20);
     ...
     * @param \Asbo\Bundle\WhosWhoBundle\Entity\Fra     $fra
     */
    public function it_has_fluent_interface($quizzAnno, $fra)
    {
