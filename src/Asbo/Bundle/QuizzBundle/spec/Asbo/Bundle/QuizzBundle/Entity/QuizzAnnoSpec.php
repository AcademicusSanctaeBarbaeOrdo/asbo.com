...
class QuizzAnnoSpec extends ObjectBehavior
{
    ...
    public function it_has_no_weighting_by_default()
    {
        $this->getWeighting()->shouldreturn(null);
    }

    public function its_wiehgting_is_mutable()
    {
        $this->setWeighting(20);
        $this->getWeighting()->shouldReturn(20);
    }

    public function it_has_no_quizz_by_default()
    {
     ...
     */
    public function its_quizz_is_mutable($quizz)
    {
        $this->setQuizz($quizz);
    ...
    public function its_date_is_mutable()
    {
        $this->setDate($date = new \DateTime());
        $this->getDate()->shouldReturn($date);
    }

    public function it_creates_quizz_anno_has_fra_collection_by_default()
    {
     ...
     */
    public function it_adds_fra_has_user_properly($quizzAnnoHasFra)
    {
     ...
     */
    public function it_calculate_average_of_quizz_by_fra($quizzAnnoHasFra1, $quizzAnnoHasFra2, $quizzAnnoHasFra3)
    {
     ...
     * @param \Asbo\Bundle\QuizzBundle\Entity\Quizz $quizz
     */
    public function it_is_convertable_to_string_and_returns_its_quizz_and_fra($quizz)
    {
     ...
     * @param \Asbo\Bundle\QuizzBundle\Entity\QuizzAnnoHasFra $quizzAnnoHasFra
     */
    public function it_has_fluent_interface($quizz, $quizzAnnoHasFra)
    {
